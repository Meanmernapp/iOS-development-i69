...
/// An enumeration.
public enum UserGender : RawRepresentable, Equatable, Hashable, CaseIterable,JSONDecodable,JSONEncodable {
  ...
  public static func == (lhs: UserGender, rhs: UserGender) -> Bool {
    switch (lhs, rhs) {
      case (.a_0, .a_0): return true
      case (.a_1, .a_1): return true
      case (.a_2, .a_2): return true
...
public final class GetAllUserMomentsQuery: GraphQLQuery {
  ...
  public let operationName: String = "GetAllUserMoments"
  ...
  public init(width: Int, characterSize: Int, first: Int, after: String, pk: String) {
    self.width = width
  ...
  public var variables: GraphQLMap? {
    return ["width": width, "characterSize": characterSize, "first": first, "after": after, "pk": pk]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("allUserMoments", arguments: ["after": GraphQLVariable("after"), "first": GraphQLVariable("first"), "pk": GraphQLVariable("pk")], type: .object(AllUserMoment.selections)),
      ]
    }
