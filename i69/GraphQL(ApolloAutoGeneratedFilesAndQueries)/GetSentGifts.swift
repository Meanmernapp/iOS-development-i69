...
public final class GetSentGiftsQuery: GraphQLQuery {
  ...
  public let operationName: String = "GetSentGifts"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("allUserGifts", arguments: ["user_Id": GraphQLVariable("user_Id")], type: .object(AllUserGift.selections)),
      ]
    }
